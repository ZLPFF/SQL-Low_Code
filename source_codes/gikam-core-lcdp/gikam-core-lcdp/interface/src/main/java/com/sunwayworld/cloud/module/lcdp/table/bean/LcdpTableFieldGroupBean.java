 ...
 * 常用表字段分组
 * 
 * @author zhaohuipeng@sunwayworld.com@sunwayworld.com
 * @date 2025-10-31
 */
@Table("T_LCDP_TABLE_FIELD_GROUP")
public class LcdpTableFieldGroupBean extends AbstractPersistable<Long> implements Insertable<Long> {
