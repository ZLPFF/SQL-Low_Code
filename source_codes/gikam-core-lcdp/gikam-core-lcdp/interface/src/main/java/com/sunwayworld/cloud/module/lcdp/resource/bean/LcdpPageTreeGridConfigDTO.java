 ...
 * 对应TreeGrid的配置
 *
 * @author zhangjr@sunwayworld.com 2024年10月3日
 */
public class LcdpPageTreeGridConfigDTO implements Serializable {
    private static final long serialVersionUID = -3572035620002717270L;
    ...
    private String moveMethod; // 移动功能
