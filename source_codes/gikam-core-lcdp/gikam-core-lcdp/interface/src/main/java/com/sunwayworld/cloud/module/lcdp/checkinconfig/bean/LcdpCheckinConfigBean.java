package com.sunwayworld.cloud.module.lcdp.checkinconfig.bean;
 ...
 * @date 2023-04-10
 */
@Table("T_LCDP_CHECKIN_CONFIG")
public class LcdpCheckinConfigBean extends AbstractInsertable<Long> implements Insertable<Long>, Activatable<Long> {
