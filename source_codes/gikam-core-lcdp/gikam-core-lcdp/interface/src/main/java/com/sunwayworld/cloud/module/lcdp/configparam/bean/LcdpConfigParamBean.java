package com.sunwayworld.cloud.module.lcdp.configparam.bean;
 ...
 * @date 2023-06-01
 */
@Table("T_LCDP_CONFIG_PARAM")
public class LcdpConfigParamBean extends AbstractInsertable<Long> implements Insertable<Long> {

    @Transient
    private static final long serialVersionUID = -82565696618766043L;
