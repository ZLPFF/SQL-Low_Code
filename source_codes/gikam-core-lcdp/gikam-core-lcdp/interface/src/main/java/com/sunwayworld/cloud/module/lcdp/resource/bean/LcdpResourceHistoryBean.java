 ...
 * @date 2022-10-17
 */
@Table("T_LCDP_RESOURCE_HISTORY")
public class LcdpResourceHistoryBean extends AbstractInsertable<Long> implements Insertable<Long> {

    @Transient
    private static final long serialVersionUID = -3099785114613815997L;
