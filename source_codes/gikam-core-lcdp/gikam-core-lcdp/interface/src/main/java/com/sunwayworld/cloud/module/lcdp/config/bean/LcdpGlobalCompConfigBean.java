 ...
 * @date 2023-04-04
 */
@Table("T_LCDP_GLOBAL_COMP_CONFIG")
public class LcdpGlobalCompConfigBean extends AbstractInsertable<Long> implements Insertable<Long> {
    ...
    @Id
    private Long id;// 主键
    private String compCategory;// 组件类型
